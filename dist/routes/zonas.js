...
router.get('/:zona_id', helpers_1.default.ensureAuthenticated, helpers_1.default.ensureIsUser, (req, res, next) => __awaiter(this, void 0, void 0, function* () {
...
router.put('/:zona_id', helpers_1.default.ensureAuthenticated, helpers_1.default.ensureIsUser, (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const zona_id = req.params.zona_id;
    const values = req.body;
    try {
        const zona = yield connection_1.default('Zonas').where({ ZonaID: zona_id }).first();
...
router.delete('/:zona_id', helpers_1.default.ensureAuthenticated, helpers_1.default.ensureIsUser, (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const zona_id = req.params.zona_id;
    try {
